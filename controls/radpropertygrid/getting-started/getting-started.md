...
This tutorial will walk you through the creation of a sample application that contains RadPropertyGrid and will show you how: 
...
__IsGrouped__ - since the Q3 2011 version of the RadControls, Telerik has added a property that controls the current RadPropertyGrid's state. You can set it to true in the xaml and you will have an initially grouped RadPropertyGrid. Or you can set it to false and you will have the GridView sorted.
